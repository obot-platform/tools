module github.com/obot-platform/tools/microsoft365/outlook/calendar

go 1.23.0

replace github.com/obot-platform/tools/microsoft365/outlook/common => ../common
...
require (
	...
	github.com/obot-platform/tools/microsoft365/outlook/common v0.0.0-20241029131940-7d95a94b38c2

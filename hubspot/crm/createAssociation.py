...
def create_association(from_object_type, from_object_id, to_object_type, to_object_id):
    resp = get_association_type_id_from_object_to_object(client, from_object_type, to_object_type)
    ...
    try:
        ...
        resp = get_association_type_id_from_object_to_object(client, to_object_type, from_object_type)
        association_spec = [{
            "associationCategory": resp.results[0].category,
            "associationTypeId": resp.results[0].type_id,
        }]
